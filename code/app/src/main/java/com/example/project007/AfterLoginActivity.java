...
public class AfterLoginActivity extends AppCompatActivity {
    ...
    private void initPop4(UserEntity userEntity) {
        LayoutInflater inflater = (LayoutInflater) AfterLoginActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        popupWindow3.showAtLocation(AfterLoginActivity.this.getWindow().getDecorView(), Gravity.CENTER, 0, 0);
    }
        ...
        popSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(popUsernameEt.getText().toString())){
                    Toast.makeText(AfterLoginActivity.this, "username is empty.",
                ...
                reference.child("data").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(temp.size() == 0){
                            Toast.makeText(AfterLoginActivity.this, "Search failed.",
                                    Toast.LENGTH_SHORT).show();
                        }else {
                            //show list
                            adapter = new RvAdapter(temp, AfterLoginActivity.this);
                            mRecyclerView.setAdapter(adapter);
                            popupWindow2.showAtLocation(AfterLoginActivity.this.getWindow().getDecorView(), Gravity.CENTER, 0, 0);
    ...
    private void initPop() {
        ...
        popEdit.setOnClickListener(new View.OnClickListener() {
            ...
            if (TextUtils.isEmpty(popEmail.getText().toString())){
                Toast.makeText(AfterLoginActivity.this, "email is empty.",
                        Toast.LENGTH_SHORT).show();
                return;
                }
            if (TextUtils.isEmpty(popPhone.getText().toString())){
                    Toast.makeText(AfterLoginActivity.this, "phone is empty.",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
            if (TextUtils.isEmpty(popUsername.getText().toString())){
                ...
                Toast.makeText(AfterLoginActivity.this, "edit success.",
                        Toast.LENGTH_SHORT).show();
                popupWindow.dismiss();
            }
        });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.main_bt1:
                popupWindow.showAtLocation(AfterLoginActivity.this.getWindow().getDecorView(), Gravity.CENTER, 0, 0);
                break;
            case R.id.main_bt2:
                popupWindow1.showAtLocation(AfterLoginActivity.this.getWindow().getDecorView(), Gravity.CENTER, 0, 0);
                break;
        }
    }
}