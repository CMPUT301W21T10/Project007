...
public class MeasurementTest {
    ...
    public void StartTest() throws InterruptedException {
        ...
        solo.enterText((EditText) solo.getView(R.id.editTextName), "M-Test");
        solo.enterText((EditText) solo.getView(R.id.editTextDescription), "Measurement Test");
        ...
        assertTrue(solo.waitForText("M-Test", 1, 2000));
        ...
        assertFalse(solo.waitForText("M-Test", 1, 2000));
        //delete Count-base
    }
